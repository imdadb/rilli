...
-- 2. Re-point role_user rows
UPDATE role_user
SET user_id = 'e591c167-0b5a-4977-b7ed-2351769a68a2'
WHERE user_id IN (
  SELECT id FROM users WHERE email IN ('superadmin','imdadb@gmail.com')
)
AND user_id <> 'e591c167-0b5a-4977-b7ed-2351769a68a2';

-- 3. Delete old user rows (no longer referenced)
DELETE FROM users
WHERE email IN ('superadmin','imdadb@gmail.com')
  AND id <> 'e591c167-0b5a-4977-b7ed-2351769a68a2';
